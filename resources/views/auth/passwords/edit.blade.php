...
<div class="content">
    ...
    @canany(['report_generate_and_mail','reports_preview'])
	    <div class="row">
	        <div class="col-lg-12">
	            <div class="panel panel-default">
	                <div class="panel-heading">
	                ...
	                <div class="panel-body">
	                    <form method="POST" action="{{ route("profile.password.updateSignPassword") }}">
	                        @csrf	                        
	                        <div class="form-group">
	                            <label class="required" for="signatory_password">Password</label>
	                            <input class="form-control" type="password" name="sign_password" id="signatory_password">
	                        </div>	                        
	                        <div class="form-group">
	                            <button class="btn btn-danger" type="submit">
	                                {{ trans('global.save') }}
