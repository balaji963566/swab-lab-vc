...
<body class="skin-blue layout-top-nav" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header">
            <nav class="navbar navbar-static-top">
            	<div style="font-size: 28px;padding-top:4px;color: #fff;text-align: center;">TMC RGMC and CSMH C R Wadia Covid 19 testing facility</div>            	
            </nav>
            <div class="container">
        		...
        		@foreach (['danger', 'warning', 'success', 'info'] as $msg)
		            @if(session('alert-'.$msg))
		                <div class="row" style='padding:20px 20px 0 20px;'>
		                    <div class="col-lg-12">
		                        <div class="alert alert-{{$msg}}" role="alert">{{ session('alert-'.$msg) }}</div>
		                    </div>
		                </div>
		            @endif
	            @endforeach
        ...
        <footer class="main-footer text-center" style="font-size: 12px;padding:6px;">
            <strong>Thane Municipal Corporation &copy;</strong> {{ trans('global.allRightsReserved') }}
        </footer>
    ...
    <script src="{{ asset('public/js/form-fileuploads.init.js') }}"></script>
