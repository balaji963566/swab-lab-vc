        ...
        <div class="col-lg-12">
        	<div class="box">
				<div class="box-header">
					<h3 class="box-title">Update Status - BHAYANDARPADA-2020-12-05-7:30</h3>
				</div>
				<!-- /.box-header -->
					...
					<table class="table table-hover">
						<tbody>
							...
							<tr>
								...
								<td>20</td>
								<td>Male</td>
								<td>SAGAR BAKERY , SAMBHAJI NAGAR, VAITI WADI, THANE</td>
								<td>NA</td>
								<td>
									<select class="form-control" name="facility_id">
	                            		...
	                            		<option value="">Resample Required</option>
		                            </select>
								</td>
							</tr>
							<tr>
